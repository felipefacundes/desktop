...
echo -e "kdesu su -c 'chattr -R -i Tudo; sleep 3h; chattr -R +i Tudo'" >> /home/$USER/.Backup/Documentos/Acessar_pasta_Tudo.sh
...
echo -e "kdesu su -c 'chattr -R +i Tudo'" >> /home/$USER/.Backup/Documentos/Travar_pasta_Tudo.sh
...
echo -e "kdesu su -c 'chattr -R -i Tudo; sleep 10h; chattr -R +i Tudo'" >> /home/$USER/.Backup/Documentos/Downloads/Acessar_pasta_Tudo.sh
...
echo -e "kdesu su -c 'chattr -R +i Tudo'" >> /home/$USER/.Backup/Documentos/Downloads/Travar_pasta_Tudo.sh
...
echo -e "kdesu su -c 'chattr -R -i Tudo; sleep 6h; chattr -R +i Tudo'" >> /home/$USER/.Backup/Música/Acessar_pasta_Tudo.sh
...
echo -e "kdesu su -c 'chattr -R +i Tudo'" >> /home/$USER/.Backup/Música/Travar_pasta_Tudo.sh
...
echo -e "kdesu su -c 'chattr -R -i Tudo; sleep 8h; chattr -R +i Tudo'" >> /home/$USER/.Backup/Vídeos/Acessar_pasta_Tudo.sh
...
echo -e "kdesu su -c 'chattr -R +i Tudo'" >> /home/$USER/.Backup/Vídeos/Travar_pasta_Tudo.sh
...
echo -e "kdesu su -c 'chattr -R -i Tudo; sleep 6h; chattr -R +i Tudo'" >> /home/$USER/.Backup/Imagens/Acessar_pasta_Tudo.sh
...
echo -e "kdesu su -c 'chattr -R +i Tudo'" >> /home/$USER/.Backup/Imagens/Travar_pasta_Tudo.sh
