...
cd "/home/maria/.jogos/wineprefixes/JogosAventura/drive_c/Games/rocketleague/Binaries/Win32"
export WINEPREFIX=~/.jogos/wineprefixes/JogosAventura/ 
/home/maria/.jogos/wines/4.0-staging/bin/winecfg "RocketLeague.exe"
