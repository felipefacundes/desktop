...
echo "StartupNotify=true" >> GTAV.desktop
...
# Opção para winetricks:   vd=1360x768 nvapi=disabled nvapi64=disabled dwrite=disabled galliumnine vulkansdk steam
...
#tar -xf mpv.tar.xz
#cd ~/.jogos/setups/mpv
#~/.jogos/wines/wine-staging-4.8-1-x86_64/bin/wineconsole mpv-install.bat
...
#~/.jogos/wines/wine-staging-4.8-1-x86_64/bin/wine regsvr32 /i /S ntdll.dll
