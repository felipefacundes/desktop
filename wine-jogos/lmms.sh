...
cd "/home/maria/.jogos/wineprefixes/lmms/drive_c/Program Files/LMMS"
...
#export DRI_PRIME=1 
export WINEPREFIX=~/.jogos/wineprefixes/lmms/
#winetricks vcrun6sp6 vcrun2010
/home/maria/.jogos/wines/3.20/bin/wine lmms.exe
#DXSDK_Jun10.exe
